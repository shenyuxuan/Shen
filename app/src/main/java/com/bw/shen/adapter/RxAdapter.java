...
public class RxAdapter extends RecyclerView.Adapter<RxAdapter.ViewHolder>{
 ...
 private List<Shops.ResultBean.RxxpBean.CommodityListBean> mList;

    public RxAdapter(Context context, List<Shops.ResultBean.RxxpBean.CommodityListBean> list) {
        mContext = context;
        mList = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(mContext, R.layout.item_rx, null);
