...
public class ToBeAdapter extends RecyclerView.Adapter<ToBeAdapter.ViewHolder>{
    private Context mContext;
    private List<IndentAll> mList;
    private ToBesAdapter mToBesAdapter;
    public ToBeAdapter(Context context) {
        mContext = context;
        mList=new ArrayList<>();
    }
    //定义日期格式
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(mContext, R.layout.item_tobe, null);
