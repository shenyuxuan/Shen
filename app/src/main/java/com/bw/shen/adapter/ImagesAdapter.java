...
public class ImagesAdapter extends RecyclerView.Adapter<ImagesAdapter.MyHodler>{
    ...
    public MyHodler onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = View.inflate(viewGroup.getContext(), R.layout.circle_images_item, null);
    ...
    public void onBindViewHolder(@NonNull MyHodler myHodler, final int position) {
        if (mList.get(position) instanceof String) {
            ...
            Uri uri = Uri.parse("res://com.bw.shen/" + id);
            myHodler.image.setImageURI(uri);
        }
