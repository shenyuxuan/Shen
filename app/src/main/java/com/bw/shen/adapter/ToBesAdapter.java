...
public class ToBesAdapter extends RecyclerView.Adapter<ToBesAdapter.ViewHolder>{
    private Context context;
    private List<IndentAll.DetailListBean> list;

    public ToBesAdapter(Context context, List<IndentAll.DetailListBean> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.item_tobes, null);
